...
async function main() {
  ...
  await transporter.sendMail({
    ...
    html:
      ...
      "                        <p style=\"font-family: sans-serif; font-size: 22px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">Hello World,</p>\n" +
      "                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">This is a simple test email.</p>\n" +
